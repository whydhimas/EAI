...
<html>
<head>
  <title>MATCH SCHEDULES | B-SPORT</title>
...
<body>
  ...
  <div style="margin-left:25%;padding:1px 16px;height:1000px;">
    ...
    <p><a href="https://stats.nba.com/schedule/" target="myFrame"><button class="btnstanding">Match Schedule by NBA</button></a>
      <a href="http://www.espn.com/nba/schedule" target="myFrame"><button class="btnstanding">Match Schedule by ESPN</button></a>
        </p>
  </div>
</body>

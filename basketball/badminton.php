...
<body>
  ...
  <div style="margin-left:25%;padding:1px 16px;height:1000px;">
    ...
    <p><a href="http://www.nba.com/standings#/" target="myFrame"><button class="btnstanding">Standing League by NBA</button></a>
        <a href="http://www.espn.com/nba/standings" target="myFrame"><button class="btnstanding">Standing League by ESPN</button></a>
        </p>
  </div>
</body>
